...
namespace Common.AsyncBundles.Bundles
{
    public class AsyncBundle : IAsyncRefs
    {
        ...
        public AsyncBundleDependency Dependencies
        {
        ...
        public IEnumerable<object> Refs
        {
            get { return _refs; }
        }

        public ILoaderInfo Loader
        {
        ...
        public bool IsReady
        {
            get { return _loaderInfo.IsLoaded && _bundle != null && (_dependency == null || _dependency.IsReady); }
        }

        public bool IsError
        {
            get { return _loaderInfo.IsError || _dependency.IsError; }
        }
        ...
        public bool UnloadInstances
        {
            get { return _keepInstances.Count == 0; }
        }

        public IDisposable KeepInstance(object value)
        {
            return new Keep(this, value);
        }
