...
using System.Linq;
using Common.AsyncBundles.Bundles.Loaders;
...
namespace Common.AsyncBundles.Bundles
{
    public class AsyncBundleQueue
    {
        ...
        public IAsyncLoaderItemProgress[] Current => _current.ToArray();

        public IAsyncLoaderItemProgress[] Queue => _queue.ToArray();
        ...
        private class LoaderItem : IAsyncLoaderItem
        {
            ...
            public Lifetime.Definition Definition
            {
            ...
            {
                get { return _lifetime.Lifetime; }
            }

            public float Progress
            {
                get { return Loader.Progress; }
            }

            public AssetBundle Bundle
            {
                get { return Loader.Bundle; }
            }
